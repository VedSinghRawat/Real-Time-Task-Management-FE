...
const TasksDetail: FC<TaskDetailBarGraphProps> = ({ className = '', taskList }) => {
  ...
  return (
    <section className={`${className}`}>
      ...
      <div className={`md:flex gap-x-10 flex-wrap mt-6`}>
        ...
        <section>
          ...
          <ul className={`list-disc ml-8`}>
            <li>
              {tasksInTimeCount} <span className={`text-sm`}>({((tasksInTimeCount / startedTasks.length) * 100).toFixed(2)}%)</span> - Were Done In
              Time
            </li>
            <li>
            ...
            <li>
              {tasksUnderTimeCount} <span className={`text-sm`}>({((tasksUnderTimeCount / startedTasks.length) * 100).toFixed(2)}%)</span> - Were
              Under Time
            </li>
          </ul>
        </section>
